...
// Three-column header keeps Code | Preview centered regardless of the
// project name or actions. Publish stays as an action button, not a tab.
//
// Below the tablet breakpoint, the project/actions share the first row,
// while Code | Preview move to a full-width second row.
