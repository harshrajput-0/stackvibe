export const ProjectCard = ({ project, onOpen }) => {
    return (
        <button className="overflow-hidden rounded-lg border! border-gray-200! bg-white text-left transition-[border-color,transform] duration-150 ease hover:-translate-y-0.5 hover:border-gray-700!" onClick={() => onOpen(project)}>
