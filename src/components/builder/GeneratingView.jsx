    ...
    <div className="rounded-md border border-gray-200 bg-white p-1.5">
      {Array.from({ length: 5 }).map((_, i) => (
        <div className="flex items-center gap-2.5 px-2.5 py-2.5" key={i}>
          ...
          <div
            className="h-3 flex-1 rounded bg-[linear-gradient(90deg,var(--gray-100),var(--gray-200),var(--gray-100))] bg-size-[200%_100%] animate-[skeleton-shimmer_1.3s_linear_infinite]"
      ...
      <div className="w-full max-w-115 rounded-lg border border-gray-200 bg-white p-[28px_26px] shadow-[0_1px_3px_rgba(0,0,0,0.05)]">
        ...
        <div className="relative mt-2 h-1.5 overflow-hidden rounded-full bg-gray-200">
          {phase === "building" ? (
            <div
              ...
              style={{ width: `${percent}%` }}
            >
              <span className="absolute inset-0 -translate-x-full bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.55),transparent)] animate-[bar-sheen_1.3s_linear_infinite]" />
            </div>
          ) : (
            <div className="h-full w-[28%] rounded-full bg-black animate-[bar-idle_1.6s_cubic-bezier(0.16,1,0.3,1)_infinite_alternate]" />
          )}
        </div>
        ...
        <div className="mt-5.5 text-[11px] font-semibold tracking-[0.04em] text-gray-400">
          {phase === "building" ? (
            ...
            <span className="animate-[pulse_1.6s_ease-in-out_infinite]">
