...
// Shown when generation finished but one or more files never made it past
// every retry round and fell back to a placeholder. The run still ends
// honestly ("Built N of M files") instead of pretending everything worked,
// and each failed file gets its own retry.
              ...
              >
                ...
                {failed && (
                  <button
                    ...
                    className="flex-none rounded-[6px] border border-gray-300 px-2 py-1 text-[11px] font-semibold text-black disabled:cursor-not-allowed disabled:opacity-50"
                  >
